...
alter table `user` add column `createdAt` timestamp(3) default CURRENT_TIMESTAMP(3) not null;

alter table `user` add column `updatedAt` timestamp(3) default CURRENT_TIMESTAMP(3) not null;
